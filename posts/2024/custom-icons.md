---
title: Custom icons
description: I create a series of custom icons for use as web components.
layout: libdoc_page.liquid
permalink: "{{ libdocConfig.blogSlug }}/custom-icons/index.html"
tags:
    - post
    - web-components
    - claude
...
The following is a conversation history with Claude on creating the icon component.
